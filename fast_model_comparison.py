...
smote = SMOTE(random_state=42, sampling_strategy=0.3)  # Reduce imbalance to 30%
...
for name, model in models.items():
    ...
    cv_scores = cross_val_score(model, X_train_balanced, y_train_balanced, cv=3, scoring='roc_auc')
